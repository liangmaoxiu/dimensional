...
var CreatePolygon = (function() {
    ...
    _.prototype._init = function(cesium) {
        ...
        this.polygonEntity=cesium.cesiumViewer.entities.add(this.options);
    };
...
var measureArea=function(cesium){
    ...
    handler.setInputAction(function() {
        ...
        billboard=billboards.add({
            ...
            scale : 1.0,
            image: GLOBAL.domainResource+'/gis/cesium/images/close.png',
...
var CreatePolyline = (function() {
    ...
    _.prototype._init = function(cesium) {
        ...
        this.lineEntity=cesium.cesiumViewer.entities.add(this.options);
    };
